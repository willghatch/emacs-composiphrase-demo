      ...
      `((verbs
        ...
        (match-table
         ...
         (
          ...
          (transpose outline ((tree-vertical ,nil) (direction forward)) (cpo-outline-transpose-sibling-forward (num)))
          (transpose outline ((tree-vertical ,nil) (direction backward)) (cpo-outline-transpose-sibling-backward (num)))
          (transpose cpo-indent-tree ((tree-vertical up)) (cpo-indent-tree-ancestor-reorder (num)))
          (transpose cpo-indent-tree ((tree-vertical ,nil) (direction forward)) (cpo-indent-tree-transpose-sibling-forward (num)))
          (transpose cpo-indent-tree ((tree-vertical ,nil) (direction backward)) (cpo-indent-tree-transpose-sibling-backward (num)))
