      ...
      `((verbs
        ...
        (objects
         ...
         ((character (default-verb . move)
          ...
          (vcs-change (default-verb . move) (location-within . beginning)) ;; eg. for going to next change or selecting change boundaries for changes since last git commit.
        ...
        (match-table
         ...
         (
          ...
          (transpose cpo-vi-like-word ((direction forward)) (,(aggreact-make-explicit-command 'cpo-transpose-cpo-vi-like-word-forward) (num)))
          (transpose cpo-vi-like-word ((direction backward)) (,(aggreact-make-explicit-command 'cpo-transpose-cpo-vi-like-word-backward) (num)))
          (transpose symbol ((direction forward)) (,(aggreact-make-explicit-command 'cpo-transpose-symbol-forward) (num)))
          (transpose symbol ((direction backward)) (,(aggreact-make-explicit-command 'cpo-transpose-symbol-backward) (num)))
          (transpose sentence ((direction forward)) (,(aggreact-make-explicit-command 'cpo-transpose-sentence-forward) (num)))
          (transpose sentence ((direction backward)) (,(aggreact-make-explicit-command 'cpo-transpose-sentence-backward) (num)))
          (transpose paragraph ((direction forward)) (,(aggreact-make-explicit-command 'cpo-transpose-paragraph-forward) (num)))
          (transpose paragraph ((direction backward)) (,(aggreact-make-explicit-command 'cpo-transpose-paragraph-backward) (num)))
          (transpose sexp ((direction forward)) (,(aggreact-make-explicit-command 'cpo-transpose-sexp-forward) (num)))
          (transpose sexp ((direction backward)) (,(aggreact-make-explicit-command 'cpo-transpose-sexp-backward) (num)))
          (transpose list ((direction forward)) (,(aggreact-make-explicit-command 'cpo-transpose-list-forward) (num)))
          (transpose list ((direction backward)) (,(aggreact-make-explicit-command 'cpo-transpose-list-backward) (num)))
          (transpose line ((direction forward)) (,(aggreact-make-explicit-command 'cpo-transpose-line-forward) (num)))
          (transpose line ((direction backward)) (,(aggreact-make-explicit-command 'cpo-transpose-line-backward) (num)))
          (transpose url ((direction forward)) (,(aggreact-make-explicit-command 'cpo-transpose-url-forward) (num)))
          ...
          (transpose cpo-treesitter-qd ((tree-vertical ,nil) (direction forward)) (,(aggreact-make-explicit-command 'cpo-treesitter-qd-transpose-sibling-forward) (num)))
          (transpose cpo-treesitter-qd ((tree-vertical ,nil) (direction backward)) (,(aggreact-make-explicit-command 'cpo-treesitter-qd-transpose-sibling-backward) (num)))
          (transpose outline ((tree-vertical up)) (cpo-outline-ancestor-reorder (num)))
          (transpose outline ((tree-vertical ,nil) (direction forward)) (,(aggreact-make-explicit-command 'cpo-outline-transpose-sibling-forward) (num)))
          (transpose outline ((tree-vertical ,nil) (direction backward)) (,(aggreact-make-explicit-command 'cpo-outline-transpose-sibling-backward) (num)))
          (transpose cpo-indent-tree ((tree-vertical up)) (cpo-indent-tree-ancestor-reorder (num)))
          (transpose cpo-indent-tree ((tree-vertical ,nil) (direction forward)) (,(aggreact-make-explicit-command 'cpo-indent-tree-transpose-sibling-forward) (num)))
          (transpose cpo-indent-tree ((tree-vertical ,nil) (direction backward)) (,(aggreact-make-explicit-command 'cpo-indent-tree-transpose-sibling-backward) (num)))
